...
namespace DialogueQuests
{
    ...
    public class ActorData : ScriptableObject
    {
        ...
        public string title;
        [Tooltip("Portrait Image (small, inside dialogue box)")]
        public Sprite portrait;
        [Tooltip("Animated Portrait (Optional)")]
        public RuntimeAnimatorController animation;

        [Header("Full Portrait")]
        [Tooltip("Full-size portrait shown on the side of the screen")]
        public Sprite portrait_full;
        [Tooltip("Which side of the screen this character's portrait appears on")]
        public PortraitSide portrait_side = PortraitSide.Left;
