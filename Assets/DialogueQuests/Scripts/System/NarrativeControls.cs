...
namespace DialogueQuests
{
    ...
    public class NarrativeControls : MonoBehaviour
    {
        ...
        {
            journal_key = (KeyCode)PlayerPrefs.GetInt("kb_journal", (int)journal_key);
        }

        public static void SaveJournalKey(KeyCode key)
        {
            PlayerPrefs.SetInt("kb_journal", (int)key);
            PlayerPrefs.Save();
        }
