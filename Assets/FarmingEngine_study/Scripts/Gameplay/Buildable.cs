...
namespace FarmingEngine
{
    ...
    public class Buildable : MonoBehaviour
    {
        ...
        List<Collider> overlap_colliders_gizmo = new();
        ...
        public bool CheckIfOverlap()
        {
            ...
            overlap_colliders_gizmo = overlap_colliders;

            //Check collision list
            foreach (Collider overlap in overlap_colliders)
            {
                if (PhysicsTool.IsLayerInLayerMask(overlap.gameObject.layer, floor_layer))
                    continue;
        ...
        public bool CheckValidFloor()
        {
            ...
            Debug.DrawRay(p0, dir, Color.blue);
        ...
        void OnDrawGizmos()
        {
            foreach (var col in overlap_colliders_gizmo)
            {
