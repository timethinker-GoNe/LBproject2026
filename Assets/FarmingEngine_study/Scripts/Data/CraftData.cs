...
namespace FarmingEngine
{
    ...
    public class CraftData : IdData
    {
        ...
        private static Dictionary<string, CraftData> craft_dict = new Dictionary<string, CraftData>();
        ...
        public static void Load(string folder = "")
        {
            ...
            foreach (CraftData data in craft_data)
            {
                if (!string.IsNullOrEmpty(data.id))
                    craft_dict[data.id] = data;
            }
        }
        ...
        public static CraftData Get(string id)
        {
            if (string.IsNullOrEmpty(id))
                return null;
            craft_dict.TryGetValue(id, out CraftData result);
            return result;
        }
