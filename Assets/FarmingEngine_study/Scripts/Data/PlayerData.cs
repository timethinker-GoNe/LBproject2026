...
namespace FarmingEngine
{
    ...
    public class PlayerData
    {
        ...
        public Dictionary<string, QuestProgress> quest_progress = new Dictionary<string, QuestProgress>();
        public Dictionary<string, Dictionary<string, bool>> npc_flags = new Dictionary<string, Dictionary<string, bool>>();
        public Dictionary<string, string> npc_status = new Dictionary<string, string>(); // npcId → 현재 상태값
        ...
        public const string last_save_id = "last_save_farming";
        public const string extension = ".farming";
        ...
        public void FixData()
        {
            ...
            if (quest_progress == null)
                quest_progress = new Dictionary<string, QuestProgress>();
            if (npc_flags == null)
                npc_flags = new Dictionary<string, Dictionary<string, bool>>();
            if (npc_status == null)
                npc_status = new Dictionary<string, string>();
