...
namespace FarmingEngine
{
    ...
    public class FullInventoryUIConfig
    {
        ...
        public float[] colPanel  = { 0.54f, 0.27f, 0.07f, 0.97f };
        public float[] colHeader = { 0.35f, 0.16f, 0.03f, 1.00f };
        public float[] colSlotBg = { 0.80f, 0.60f, 0.28f, 1.00f };
        public float[] colHover  = { 0.95f, 0.75f, 0.40f, 1.00f };
        public float[] colTitle  = { 1.00f, 0.92f, 0.72f, 1.00f };
    }
    ...
    public class FullInventoryPanel : ItemSlotPanel
    {
        ...
        private static Color GetColor(float[] c, Color fallback) =>
            c != null && c.Length >= 4 ? new Color(c[0], c[1], c[2], c[3]) : fallback;
        ...
        {
            Color colPanel  = GetColor(cfg.colPanel,  new Color(0.54f, 0.27f, 0.07f, 0.97f));
            Color colHeader = GetColor(cfg.colHeader, new Color(0.35f, 0.16f, 0.03f, 1.00f));
            Color colTitle  = GetColor(cfg.colTitle,  new Color(1.00f, 0.92f, 0.72f, 1.00f));
        ...
        {
            Color colSlotBg = GetColor(cfg.colSlotBg, new Color(0.80f, 0.60f, 0.28f, 1.00f));
            Color colHover  = GetColor(cfg.colHover,  new Color(0.95f, 0.75f, 0.40f, 1.00f));
